            ...
            <TouchableOpacity
              ...
              <View
                ...
                <Text
                  ...
                  {Lang_chg.verificationotp[config.language]}
                </Text>
                <Text
                  style={{fontFamily: 'Piazzolla-Bold', alignSelf: 'center'}}>
                  {Lang_chg.verificationcodeheding[config.language]}
                </Text>
                {this.props.email != null && (
                  <Text
                    style={{fontFamily: 'Piazzolla-Bold', alignSelf: 'center'}}>
                    {Lang_chg.phoneotp[config.language]} : {this.props.email}
                  </Text>
                )}
                <TextInput
